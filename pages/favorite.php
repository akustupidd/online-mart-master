...
?>
	...
	<?php 
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td class="shoping__cart__item__close">
                                       <a href="pages/delete.php?Caid=<?= $row['CaID'] ?>"> <span class="icon_close"></a> Unfavorite</span>
                                    </td>
                                </tr>
								<?php
                                        }
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        ...
                        <a href="index.php?p=shoping-cart" class="primary-btn cart-btn">CONTINUE CARD</a>
        ...
        <?php else:  ?>
            <div align="center">
                <h2 style="font-weight:bold">No Product in Favorite</h2>
            </div>
        <?php endif;?>
    </section>
